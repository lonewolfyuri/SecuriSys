...
class Fog:
    ...
    def _ship_hub(self):
        ...
        blob = self.image_bucket.blob('%d-%d-%d_%d-%d-%d.txt' % (self.hub_dt.month, self.hub_dt.day, self.hub_dt.year, self.hub_dt.hour, self.hub_dt.minute,self.hub_dt.second))
    ...
    def _ship_screenshot(self):
        ...
        dtime = datetime.now()
        blob = self.image_bucket.blob('%d-%d-%d_%d-%d-%d.jpeg' % (dtime.month, dtime.day, dtime.year, dtime.hour, dtime.minute, dtime.second))
    ...
    def _ship_video(self):
        ...
        blob = self.image_bucket.blob('%d-%d-%d_%d-%d-%d.mp4' % (self.footage_dt.month, self.footage_dt.day, self.footage_dt.year, self.footage_dt.hour, self.footage_dt.minute, self.footage_dt.second))
